 ...
 *
 * System commands: uname, ps, env, etc.
 * These provide system information from the device.
 */
 ...
 * Command: uname
 *
 * Get system information (kernel name, hostname, release, machine).
 * ============================================================================= */
 ...
 * Command: ps
 *
 * List processes with their PID, PPID, name, state, and cmdline.
 * Client will render this as a tree.
 * ============================================================================= */
 ...
 * Command: exec
 *
 * Execute a binary directly using fork + execve.
 * No shell dependency - parses command string into argv ourselves.
 * ============================================================================= */
 ...
 * Command: netstat
 *
 * List network connections (TCP/UDP, IPv4/IPv6) with process information.
 * Reads directly from /proc/net/* - no external tools needed.
 * ============================================================================= */
...
int cmd_netstat(conn_t *conn, uint32_t id, const uint8_t *args, size_t args_len)
{
    ...
    LOG("netstat: found %zu connections", nconns);
 ...
 * Command: kill-agent
 *
 * Kill the parent agent process (only works in bind/fork mode).
 * The child sends SIGTERM to its parent, causing the main listener to exit.
 * ============================================================================= */
